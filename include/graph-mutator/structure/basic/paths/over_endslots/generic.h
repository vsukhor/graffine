...
#ifndef GRAPH_MUTATOR_STRUCTURE_BASIC_PATHS_OVER_ENDSLOTS_GENERIC_H
#define GRAPH_MUTATOR_STRUCTURE_BASIC_PATHS_OVER_ENDSLOTS_GENERIC_H
...
#endif  // GRAPH_MUTATOR_STRUCTURE_BASIC_PATHS_OVER_ENDSLOTS_GENERIC_H
